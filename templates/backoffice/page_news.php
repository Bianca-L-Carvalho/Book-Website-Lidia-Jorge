...
<div class="d-flex justify-content-center">
  <nav aria-label="Search results pages">
    <ul class="pagination">
      ...
      <li class="page-item"><a class="page-link pagination-font-style" href="">1</a></li>
      <li class="page-item"><a class="page-link pagination-font-style" href="">2</a></li>
      <li class="page-item"><a class="page-link pagination-font-style" href="">3</a></li>
      <li class="page-item"><a class="page-link pagination-font-style" href="">...</a></li>
      <li class="page-item"><a class="page-link pagination-font-style" href="">10</a></li>
      <li class="page-item">
